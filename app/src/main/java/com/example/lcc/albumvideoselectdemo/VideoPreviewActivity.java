...
public class VideoPreviewActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ImageView buttonShoot;
    private ImageView videoSure;
    /**
     * 视频路径
     */
    private String path;
    ...
    private void assignViews() {
        ...
        videoViewShow.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);
        ...
        buttonShoot = (ImageView) findViewById(R.id.video_cancle);
        videoSure = (ImageView) findViewById(R.id.video_sure);
